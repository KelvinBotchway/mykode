  ...
  return (
      ...
      <div className="Nav-content flex flex-row items-center justify-between">
        ...
        <div className="Nav-right flex flex-row items-center">
          <Link
            to="/register/host/credentials"
            className="ml-8 hover:text-white app-text-pink border-2 py-2 px-4 border-app-pink hover:bg-app-pink transition ease-in-out duration-500"
          >
